...
DEEPL_API_KEY, output_path, marker_char, USE_DEEPL_API = (
    None,
    None,
    None,
    False,
...
def read_config():
    ...
    global DEEPL_API_KEY, output_path, marker_char, USE_DEEPL_API
    ...
    print(
        f"Deepl API key: {DEEPL_API_KEY}, Output folder: {output_path}, Use Deepl API: {USE_DEEPL_API}"
    )
